...
const Map<String, OfferPracticalInfo> _offerPracticalInfoByCode =
  ...
  'preventive_cardiometabolic_panel': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 240',
    locationLabel: 'Munich clinic or secure video follow-up',
    locationShortLabel: 'Munich or video',
    clinicianLabel: 'Preventive cardiology physician',
  ...
  'cardiology_follow_up_visit': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 220',
    locationLabel: 'Munich heart clinic or secure video follow-up',
    locationShortLabel: 'Munich or video',
    clinicianLabel: 'Cardiologist or cardiac nurse practitioner',
  ...
  'cardiac_rehab_intake': OfferPracticalInfo(
    ...
    locationLabel: 'Munich rehab center',
    locationShortLabel: 'Munich rehab',
    clinicianLabel: 'Cardiac rehab therapist',
  ...
  'advanced_lipid_lab_panel': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 140',
    locationLabel: 'Partner lab in central Munich',
    locationShortLabel: 'Partner lab',
    clinicianLabel: 'Lab team with clinician review',
  ...
  'movement_program': OfferPracticalInfo(
    ...
    locationLabel: 'Video check-ins with in-app plan tracking',
    locationShortLabel: 'Video + app',
    clinicianLabel: 'Movement coach',
  ...
  'nutrition_coaching': OfferPracticalInfo(
    ...
    locationLabel: 'Video coaching with in-app tracking',
    locationShortLabel: 'Video + app',
    clinicianLabel: 'Nutrition coach',
  ...
  'heart_health_supplement_review': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 95',
    locationLabel: 'Video or in-clinic add-on review',
    locationShortLabel: 'Video or clinic',
    clinicianLabel: 'Clinician with medication review',
  ...
  'longevity_intake_visit': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 260',
    locationLabel: 'Munich clinic or secure video visit',
    locationShortLabel: 'Munich or video',
    clinicianLabel: 'Longevity physician',
  ...
  'baseline_lab_workup': OfferPracticalInfo(
    ...
    categoryLabel: 'Lab test',
    priceLabel: 'EUR 190',
    locationLabel: 'Partner lab network in Munich',
    locationShortLabel: 'Partner lab',
    clinicianLabel: 'Lab team with clinician summary',
  ...
  'cardiovascular_screening_visit': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 260',
    locationLabel: 'Munich clinic',
    locationShortLabel: 'Munich clinic',
    clinicianLabel: 'Preventive cardiology physician',
  ...
  'sleep_recovery_package': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 145',
    locationLabel: 'Video review with optional sleep kit handoff',
    locationShortLabel: 'Video review',
    clinicianLabel: 'Sleep-focused clinician or coach',
  ...
  'follow_up_prep': OfferPracticalInfo(
    ...
    priceLabel: 'EUR 75',
    locationLabel: 'In-app planning session',
    locationShortLabel: 'In app',
    clinicianLabel: 'Care coordinator',
